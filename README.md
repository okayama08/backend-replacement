...
This repository hosts the source code of BlueZakex backend. The backend provides off-chain orderbook functionality and an API to get a filtered view of Ethereum blockchain events on an [EtherDelta-like contract](https://www.reddit.com/r/EtherDelta/comments/6kdiyl/smart_contract_overview/).
...
Copyright (C) 2018, Arseniy Ivanov and BlueZakex Contributors
